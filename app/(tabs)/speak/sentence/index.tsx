        ...
        <View className="mt-4 px-6 items-center justify-center">
          ...
          {[1, 2, 3, 4].map((num) => (
            <TouchableOpacity
              ...
              className="w-full bg-white p-6 rounded-[24px] mb-4 mx-4 shadow-sm items-center active:scale-95 transition-transform"
            >
              <Text className="text-3xl font-[Montserrat-Bold] text-[#2563EB]">
                {num}
              </Text>
              <Text className="text-gray-400 text-xs font-[Montserrat-Medium] mt-1">
                SENTENCES
              </Text>
            </TouchableOpacity>
          ))}
