    ...
    <View className="flex-1 bg-[#F6F6F6]">
      ...
      <ScrollView>
        <View className="mt-4 px-6 items-center justify-center">
          <Text className="font-[Montserrat-Bold] text-xl mb-2 text-[#1F2937]">
            Pronunciation Practice
          </Text>
          <Text className="text-center font-[Montserrat-Medium] text-[#939393] mb-6">
            Practice words and sentences to improve your speaking skills.
          </Text>
