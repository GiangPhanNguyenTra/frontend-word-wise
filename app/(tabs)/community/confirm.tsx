            ...
            <ScrollView className="flex-1 px-4 gap-5 mt-4" contentContainerStyle={{flexGrow: 1, paddingBottom: 20 }}>
                <View className="flex-1 justify-between">
                    <View className="items-center gap-5 px-2">
                        <Text className="font-[Montserrat-Bold] text-lg text-black">Public Policy</Text>
                        <Text className="text-base font-[Montserrat-Regular] text-black">
                ...
                <View className="px-3">
                    ...
                    >
                        <Text className="text-white text-base font-[Montserrat-Bold]">Agree</Text>
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </View>
